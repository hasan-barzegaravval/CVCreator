        ...
        /**
         * Main JavaScript funnction. this method create and return elements of your Html.
         * Data is the json Data loaded to your HTML.
         * Classes used here to create elements are from Lib.js loaded.
         * 
         * @returns does not return any value. void function.
        ...
        function main(){
           ...
           Pub.El.ToSHow();
           let El5=new Element({tag:"h2",Class:"SectionHeader",Text:"References"},References,["Element",(DATA.References==null?"Broken":"main")]).ToSHow();
        }
        main();
